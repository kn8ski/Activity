...
//                btn_0.doClick();
    ...
    public static void init_tbl_myteachers(JTable tbl_myteachers) {
        ...
        int[] tbl_widths_myteachers= {50,100,100,100,50,50,0,0,0,0,0};
